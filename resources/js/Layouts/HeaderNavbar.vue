...
import Dropdown from "../components/shared/ui/dropdown/Dropdown.vue";
...
<template>
    <div class="flex items-center border-b px-5">
        ...
        <NavigationMenuRoot
            ...
            class="relative z-[999] flex w-full justify-center h-[50px] items-center"
        >
            <NavigationMenuList
                class="center shadow-blackA7 m-0 flex list-none rounded-[6px] bg-transparent p-1"
            >
                <NavigationMenuItem>
                    <NavigationMenuTrigger
                        class="text-black hover:bg-green3 focus:shadow-green7 group flex select-none items-center justify-between gap-[2px] rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none outline-none focus:shadow-[0_0_0_2px]"
                    >
                        Learn
                        <Icon
                            icon="radix-icons:caret-down"
                            class="text-black relative top-[1px] transition-transform duration-[250] ease-in group-data-[state=open]:-rotate-180"
                            aria-hidden
                        />
                    </NavigationMenuTrigger>
                    <NavigationMenuContent
                            ...
                            <li class="row-span-3 grid">
                                <NavigationMenuLink as-child>
                                    ...
                                    >
                                        ...
                                        <p
                                            class="text-mauve4 text-[14px] leading-[1.3]"
                                        >
                ...
                <NavigationMenuItem>
                    <NavigationMenuLink
                        class="text-black hover:bg-green3 focus:shadow-green7 block select-none rounded-[4px] px-3 py-2 text-[15px] font-medium leading-none no-underline outline-none focus:shadow-[0_0_0_2px]"
